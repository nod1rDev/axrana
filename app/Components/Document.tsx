        ...
        <div className="min-w-[100%] mx-auto mb-[3000000px]">
          ...
          <section className="mb-5 text-[14px]">
            ...
            <p className="mb-0">
              ...
              ҳужжатларига мувофиқ жавобгар ҳисобланади. Хизматлар ҳақини уз вақтида тўланмагани учун "Буюртмачи" "Бажарувчи" га ўтказиб юборилган хар бир кун учун кечиктирилган тўлов суммасининг 50 фоизидан ортиқ бўлмаган миқдорда пеня тўлайди
            </p>
            <p className="mb-0">
