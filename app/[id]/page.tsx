              ...
              <div className="container rounded-lg  bg-[#f4f3ee] px-6 py-4 mx-auto p-4  text-justify">
                ...
                <section className="mb-4">
                  ...
                  <p className="mb-0">
                    ...
                    жавобгар ҳисобланади. Хизматлар ҳақини уз вақтида
                    тўланмагани учун "Буюртмачи" "Бажарувчи" га ўтказиб
                    юборилган хар бир кун учун кечиктирилган тўлов суммасининг
