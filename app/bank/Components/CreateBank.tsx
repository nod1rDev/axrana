...
const columns: readonly Column[] = [
  ...
  { id: "unvonNomi", label: "Bank Nomi", align: "left", minWidth: "100%" },
  {
    id: "unvonNarxi",
    label: "Bank Raqami",
    minWidth: 180,
...
export default function CreateBank({
  ...
  const rows: any = data
    ? data.map((e: any) => createData(1, e.name, e.number, 5, e._id))
    : [];
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    if (valueInp.name && valueInp.number) {
      setData([
        ...data,
        {
          name: valueInp.name,
          number: valueInp.number,
          date: DateFilt(),
      ...
      <Accordion sx={{ backgroundColor: "transparent" }}>
        ...
        <AccordionDetails>
          <form
            ...
            className="flex justify-between gap-5 py-[6px]  px-5"
          >
            <TextField
              id="outlined-basic"
              label="Bank Nomi"
