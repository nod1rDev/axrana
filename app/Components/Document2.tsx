        ...
        <div className="min-w-[100%] mx-auto mb-[3000000px]">
          ...
          <section className="mb-5 text-[14px]">
            ...
            <p className="mb-0">
              ...
              ҳужжатларига мувофиқ жавобгар ҳисобланади. Хизматлар ҳаққини ўз
              вақтида тўламаганлик учун "Буюртмачи" "Бажарувчи"га етказиб
              берилмаган ҳар бир кун учун кечиктирилган тўлов суммасининг 0,4
              фоизи миқдорида, аммо кечиктирилган тўлов суммасидан 50 фоизидан
