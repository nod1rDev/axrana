              ...
              <div className="container rounded-lg  bg-[#f4f3ee] px-6 py-4 mx-auto p-4  text-justify">
                ...
                <section className="mb-4">
                  ...
                  <p className="mb-0">
                    ...
                    жавобгар ҳисобланади. Хизматлар ҳаққини ўз вақтида
                    тўламаганлик учун "Буюртмачи" "Бажарувчи"га етказиб
                    берилмаган ҳар бир кун учун кечиктирилган тўлов суммасининг
                    0,4 фоизи миқдорида, аммо кечиктирилган тўлов суммасидан 50
                    фоизидан ортиқ бўлмаган миқдорда пеня тўлайди.
                  </p>
                  <p className="mb-0">
